<template>
  ...
  <div class="bg-base-200 px-12 py-4">
  <PageHeading :pageHeaderInfo="pageHeaderInfo"/>
...
<div class="border-b border-white/10 pb-12">
  <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-8 justify-items-center items-center sm:justify-items-start">
    ...
    <div class="mt-6 flex items-center justify-end gap-x-6">
      <button @click="$inertia.visit(route('campaigns.index'))" type="button" class="btn btn-secondary">Annulla</button>
