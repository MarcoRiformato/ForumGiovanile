    ...
    <div class="relative isolate overflow-hidden">
      ...
      <div class="mx-auto max-w-2xl mt-10 sm:mt-0 sm:py-48 lg:py-56">
          ...
          <div v-else class="text-center">
              <h1 class="text-2xl  sm:text-4xl font-bold tracking-tight text-white sm:text-6xl">Nessuna elezione attiva</h1>
              <p class="mt-3 sm:mt-6 text-white text-sm sm:text-lg leading-8">Al momento non ci sono sondaggi o elezioni attive.</p>
          </div>
      </div>
